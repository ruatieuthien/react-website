          ...
          <section className="contact mtop">
              <div className="container flex">
                  <div className="main-content">
                      ...
                      <form action="" onSubmit={formSubmit}>
                          ...
                          <div className="input inputlast">
                                  ...
                                  <textarea name="message" id="" value={message} cols="30" rows="10" onChange={(e) => setMessage(e.target.value)}></textarea>
                          </div>
                  ...
                  <div className="side-content">
                      ...
                      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ex officiis expedita perspiciatis consequatur voluptatem maxime fugiat quo?</p>
                      <br />
                      <h3>Message Us</h3>
                      <span>letuananh06101997@gmail.com</span>
                      <br />
                      <span>+84981 330 085</span>
                      <br />
